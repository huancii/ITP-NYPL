...
urlpatterns = [
    ...
    path('new_transcription/', hwtgenml_views.new_transcription, name='new_transcription'),
    path('test_transcription/', hwtgenml_views.test_transcription, name='test_transcription'),
    path('test_transcription_start/', hwtgenml_views.test_transcription_start, name='test_transcription_start'),
    path('view_transcription/', hwtgenml_views.view_transcription, name='view_transcription'),
    path('view_transcription_detail/', hwtgenml_views.view_transcription_detail, name='view_transcription_detail'),
    path('report_transcription/', hwtgenml_views.report_transcription, name='report_transcription'),
    path('report_transcription_detail/', hwtgenml_views.report_transcription_detail, name='report_transcription_detail'),
    path('reset_original_confidence_level/', hwtgenml_views.reset_original_confidence_level, name='reset_original_confidence_level'),
